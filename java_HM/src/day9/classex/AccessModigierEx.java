...
public class AccessModigierEx {
	...
	public static void main(String[] args) {
		...
		// num3는 접근제어자가 public
		// AccessModifire 클래스와 A 클래스는 같은 패키지에 있는 클래스
		// AccessModifire 클래스와 B 클래스는 다른 패키지에 있는 클래스
		a.num3 = 10;
		b.num3 = 20;
		
		// num2는 접근제어자가 디폴트(생략됨). 다른패키지에 있는 B 클래스의 객체는 접근이 안됨
		a.num2 = 10;
		// b.num2 = 20;
...
class A{
	...
	// private으로 된 num1에 값을 변경하기 위하여 setter를 추가.
