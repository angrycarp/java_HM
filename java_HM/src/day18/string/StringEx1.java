...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str + "에서 7번지부터 몇 번지에 wo 가 있나요 ? " + index);
		
		index = str.indexOf("wo");
		System.out.println(str + "에서 0번지부터 몇 번지에 wo 가 있나요 ? " + index);
		
		index = str.indexOf("o");
		System.out.println(str + "에서 0번지부터 몇 번지에 o 가 있나요 ? " + index);
		...
		//replaceAll : 정규표현식에 맞는 모든 문자 / 문자열 수정
