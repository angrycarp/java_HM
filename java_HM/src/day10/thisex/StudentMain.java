...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		Student1 std1 = new Student1(1,1,1,"lim");
		Student1.printCount();
		
		Student1 std2 = new Student1(2,2,2,"hong");
		Student1.printCount();
...
class Student1{
	...
	private String name;
	// 아래 생성자는 매개변수가 있고, 매개변수의 이르이 멤버변수와 같기 떄문에
	// 맴버 변수를 호출할 때 this를 반드시 붙여야 함.
	...
	// 기본 생성자는 매게변수가 없기 때문에 this를 안써도 됨.
	public Student1() {
		// 맴버변수와 이름이 같은 지역 변수를 만들수도 있다.(비추천)
		// int grade = 10;
		// this.grade = grade; 
		this(1,1,1,"");
		/*
