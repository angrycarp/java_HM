/*
if(수식, 참, 거짓)
ifnull(속성, 값) : 속성 값이 null이 아니면 속성값을 이용하고, null이면 괄호 안의 값을 이용 
...
:날짜로부터 차이만큼 더한/뺀 날짜
차이 : interval 숫자 단위(day, month, date, hour, minute, second);
...
from student;
select instr(title, '학수') as 대학위치, title from subject;
...
select datediff('2023-08-03 14:00:00', '2023-08-02 13:00:00');
